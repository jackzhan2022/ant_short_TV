...
- [x] 1.1 Add focused backend tests covering empty-variant prompt derivation, preservation of non-empty prompts, and character primary-image validation.
...
- [x] 1.5 Keep scene and prop visual-variant image tasks text-based and verify existing generation behavior remains compatible.
...
- [x] 2.4 Pass the canonical character primary image as the reference image for character variant generation and present the server validation message when it is unavailable.

## 3. Verification

- [x] 3.1 Run focused backend and frontend regression tests for asset settings and image-task submission.
- [x] 3.2 Run frontend type checking and production build.
- [x] 3.3 Run OpenSpec strict validation for `improve-visual-variant-generation`.
