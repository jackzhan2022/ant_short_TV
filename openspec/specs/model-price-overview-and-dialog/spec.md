# model-price-overview-and-dialog Specification

## Purpose
Make current model pricing visible from the AI-model list and keep pricing changes in the selected model's context.
