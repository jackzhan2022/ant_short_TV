...
The system MUST place authenticated users in Spring SecurityContext and SHALL require authentication for protected API routes unless an endpoint is explicitly classified as public.
...
- **THEN** the system returns the standard JSON 401 response before controller business logic executes
