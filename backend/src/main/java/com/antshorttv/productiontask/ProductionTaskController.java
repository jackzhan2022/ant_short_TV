...
public class ProductionTaskController {
    ...
    @GetMapping("/{taskKey}/content/{sectionKey}") public ApiResponse<Map<String,Object>> contentSection(@PathVariable long tenantId,@PathVariable String taskKey,
        @PathVariable String sectionKey,@RequestParam(defaultValue="0") int offset,@RequestParam(defaultValue="1") int page,
        @RequestParam(defaultValue="20") int pageSize) {
        return ApiResponse.success(service.contentSection(tenantId,taskKey,sectionKey,offset,page,pageSize));
    }
