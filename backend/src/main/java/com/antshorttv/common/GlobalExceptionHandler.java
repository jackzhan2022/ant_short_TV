    ...
    public ResponseEntity<ApiResponse<Void>> handleBusinessException(BusinessException exception) {
        HttpStatus status = switch (exception.getErrorCode()) {
            ...
            case DUPLICATE_MOBILE, DUPLICATE_PENDING_INVITATION, ALREADY_TENANT_MEMBER,
                ...
                ORGANIZATION_HAS_MEMBERS, PROJECT_MEMBER_EXISTS, AI_VIDEO_RESULT_IN_USE,
                AI_VIDEO_CONCURRENCY_LIMIT_EXCEEDED -> HttpStatus.CONFLICT;
            case NOT_FOUND, INVITATION_EXPIRED, ROLE_NOT_FOUND, PERMISSION_NOT_FOUND,
                ...
                AI_PROVIDER_NOT_FOUND, AI_SERVICE_CONFIG_NOT_FOUND, AI_VIDEO_TASK_NOT_FOUND,
                AI_VIDEO_RESULT_NOT_FOUND, AI_VIDEO_STORYBOARD_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case ORGANIZATION_LEVEL_EXCEEDED, PROJECT_ARCHIVED, AI_VIDEO_TASK_STATUS_INVALID -> HttpStatus.UNPROCESSABLE_ENTITY;
            case VALIDATION_ERROR, AI_VIDEO_SERVICE_UNAVAILABLE, AI_VIDEO_STORYBOARD_FIRST_FRAME_REQUIRED -> HttpStatus.BAD_REQUEST;
        };
