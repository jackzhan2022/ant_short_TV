    ...
    public ResponseEntity<ApiResponse<Void>> handleBusinessException(BusinessException exception) {
        HttpStatus status = switch (exception.getErrorCode()) {
            ...
            case DUPLICATE_MOBILE, DUPLICATE_PENDING_INVITATION, ALREADY_TENANT_MEMBER,
                ...
                SHOT_COMPOSE_RESULT_IN_USE -> HttpStatus.CONFLICT;
            case NOT_FOUND, INVITATION_EXPIRED, ROLE_NOT_FOUND, PERMISSION_NOT_FOUND,
                ...
                SHOT_COMPOSE_RESULT_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case ORGANIZATION_LEVEL_EXCEEDED, PROJECT_ARCHIVED, AI_VIDEO_TASK_STATUS_INVALID,
                AI_VOICE_TASK_STATUS_INVALID, SHOT_COMPOSE_TASK_STATUS_INVALID -> HttpStatus.UNPROCESSABLE_ENTITY;
            case VALIDATION_ERROR, AI_IMAGE_SERVICE_UNAVAILABLE, AI_VIDEO_SERVICE_UNAVAILABLE,
                ...
                SHOT_COMPOSE_STORYBOARD_VIDEO_REQUIRED -> HttpStatus.BAD_REQUEST;
        };
