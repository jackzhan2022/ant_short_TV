...
public class AiCallLogWriter {
    ...
    public Long record(AiInvocationLogRequest logRequest) {
        ...
        jdbcTemplate.update(connection -> {
            ...
            ps.setString(8, trimSummary(logRequest.requestSummary()));
            ps.setString(9, trimSummary(logRequest.responseSummary()));
            ps.setString(10, logRequest.status());
            ps.setString(11, trimSummary(logRequest.errorMessage()));
