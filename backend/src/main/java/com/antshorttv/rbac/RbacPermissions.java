...
final class RbacPermissions {
    ...
    static final List<RbacPermissionDefinition> ALL = List.of(
        ...
        new RbacPermissionDefinition("PLATFORM_AI_PROVIDER_VIEW", "查看平台AI服务商", PermissionType.PAGE, "PLATFORM_AI_PROVIDER", "VIEW"),
        new RbacPermissionDefinition("PLATFORM_AI_PROVIDER_CREATE", "新增平台AI服务商", PermissionType.BUTTON, "PLATFORM_AI_PROVIDER", "CREATE"),
        new RbacPermissionDefinition("PLATFORM_AI_PROVIDER_EDIT", "编辑平台AI服务商", PermissionType.BUTTON, "PLATFORM_AI_PROVIDER", "EDIT"),
        new RbacPermissionDefinition("PLATFORM_AI_PROVIDER_TEST", "测试平台AI服务商", PermissionType.BUTTON, "PLATFORM_AI_PROVIDER", "TEST"),
        new RbacPermissionDefinition("PLATFORM_AI_PROVIDER_ENABLE", "启停平台AI服务商", PermissionType.BUTTON, "PLATFORM_AI_PROVIDER", "ENABLE"),
        new RbacPermissionDefinition("PLATFORM_AI_PROVIDER_DELETE", "删除平台AI服务商", PermissionType.BUTTON, "PLATFORM_AI_PROVIDER", "DELETE"),
        new RbacPermissionDefinition("PLATFORM_AI_MODEL_VIEW", "查看平台AI模型", PermissionType.PAGE, "PLATFORM_AI_MODEL", "VIEW"),
        new RbacPermissionDefinition("PLATFORM_AI_MODEL_CREATE", "新增平台AI模型", PermissionType.BUTTON, "PLATFORM_AI_MODEL", "CREATE"),
