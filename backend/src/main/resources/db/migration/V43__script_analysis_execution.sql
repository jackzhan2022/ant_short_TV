...
values
  ('script_analysis', null, 'TEXT', 1, 'PUBLISHED', '2000-01-01 00:00:00', null,
...
select id, 'CALL', 1, 1, '{}', '', now()
  from ai_point_policy_version
 where scene = 'script_analysis' and version_no = 1;

create unique index uk_script_analysis_task_execution on script_analysis_task (execution_id);
