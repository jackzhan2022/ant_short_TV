...
values
  ('ai_video_generate', null, 'VIDEO', 1, 'PUBLISHED', '2000-01-01 00:00:00', null,
...
select id, 'FIXED_EXECUTION', 1, 1, '{}', '', now()
 ...
 where scene = 'ai_video_generate' and version_no = 1;

create unique index uk_ai_video_task_execution on ai_video_task (execution_id);
