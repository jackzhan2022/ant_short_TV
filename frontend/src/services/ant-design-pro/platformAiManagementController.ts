...
/** 此处后端没有提供注释 GET /api/platform/ai/models/${param0}/parameters */
export async function modelParameters(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.modelParametersParams,
  options?: { [key: string]: any }
) {
  const { id: param0, ...queryParams } = params;
  return request<API.ApiResponseAiModelParameterResponse>(
    `/api/platform/ai/models/${param0}/parameters`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
/** 此处后端没有提供注释 PUT /api/platform/ai/models/${param0}/parameters */
export async function updateModelParameters(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.updateModelParametersParams,
  body: API.AiModelParameterRequest,
  options?: { [key: string]: any }
) {
  const { id: param0, ...queryParams } = params;
  return request<API.ApiResponseAiModelParameterResponse>(
