export default {
  ...
  'pages.welcome.celebrationTitle': '欢迎使用剧智创',
  ...
  'pages.productionWorkbench.assets.reviewQueue': '待审核识别结果',
  'pages.productionWorkbench.assets.variantsAndBindings': '视觉形象与剧集绑定',
};
